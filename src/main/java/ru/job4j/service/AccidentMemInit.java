...
public class AccidentMemInit {
    ...
    private void accidentInit() {
        var accident1 = Accident.of(
                ...
                new HashSet<>(List.of(ruleRepo.findById(1L).get(), ruleRepo.findById(2L).get()))
        );
        var accident2 = Accident.of(
                ...
                new HashSet<>(List.of(ruleRepo.findById(1L).get(), ruleRepo.findById(3L).get()))
        );
        var accident3 = Accident.of(
                ...
                new HashSet<>(List.of(ruleRepo.findById(1L).get()))
        );
        var accident4 = Accident.of(
                ...
                accidentTypeRepo.findById(3L).get(),
                new HashSet<>(List.of(ruleRepo.findById(3L).get(), ruleRepo.findById(2L).get()))
        );
